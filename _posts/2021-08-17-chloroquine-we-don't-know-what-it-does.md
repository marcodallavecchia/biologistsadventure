...
While the further development of this drug kept going (like the synthesis of Hydroxychloroquine and other modified variants), [like it happens many times](https://marcodallavecchia.github.io/biologistsadventure/eng/antibiotic-resistance/) in nature, **chloroquine-resistant strains** became widespread, and it led to an almost complete stop to the use of chloroquine in malaria treatment, at least as a single-shot solution [1].
